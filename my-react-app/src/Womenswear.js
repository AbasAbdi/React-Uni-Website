...
function Womenswear(props) {
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${11}`, value1)
              .then((response) => {
                // handle success
                var resData = response.data;
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${12}`, value2)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${13}`, value3)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${14}`, value4)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${15}`, value5)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${16}`, value6)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${17}`, value7)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${18}`, value8)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${19}`, value9)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${20}`, value10)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${21}`, value11)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${22}`, value12)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${23}`, value13)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${24}`, value14)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${25}`, value15)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data &&
        cor.data.map((info) => {
          if (
            ...
            axios
              .put(`http://localhost:8080/updateProduct/${26}`, value16)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
  ...
  // Return for the Womenswear function
  return (
    <main>
      {fetchRecords()}
        ...
        <div className={classes.heroButtons}>
          <div className={classes.root}>
            ...
            >
              ...
              <Tab label="DRESSY TOPS" {...a11yProps(1)} />
              <Tab label="COATS AND JACKETS" {...a11yProps(2)} />
              <Tab label="SKIRTS" {...a11yProps(3)} />
            </Tabs>
...
// exporting the Womenswear function
