...
// Customer function that takes props as arguments
function Customer(props) {
  // Declaring the props for this function
  const { customer_id, fName1, lName1 } = props;
  ...
  var savePersonal = once(function () {
    ...
    axios
      .put(`http://localhost:8080/savePersonal/${customer_id}`, value)
      .then((response) => {
        // handle success
  ...
  var saveAddress = once(function () {
    ...
    axios
      .put(`http://localhost:8080/saveAddress/${customer_id}`, value1)
      .then((response) => {
        // handle success
        var resData = response.data;
        let data = JSON.stringify(resData);
  ...
  var saveBank = once(function () {
    ...
    axios
      .put(`http://localhost:8080/saveBank/${customer_id}`, value2)
      .then((response) => {
        // handle success
        var resData = response.data;
        let data = JSON.stringify(resData);
  ...
  // Return for the Customer function
...
// exporting the Customer function
