...
function DeptMen() {
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(27)) {
          if (current_price1 !== null && current_price1 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${27}`, value)
              .then((response) => {
                // handle success
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(28)) {
          if (current_price2 !== null && current_price2 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${28}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(29)) {
          if (current_price3 !== null && current_price3 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${29}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(30)) {
          if (current_price4 !== null && current_price4 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${30}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(31)) {
          if (current_price5 !== null && current_price5 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${31}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(32)) {
          if (current_price6 !== null && current_price6 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${32}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(33)) {
          if (current_price7 !== null && current_price7 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${33}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(34)) {
          if (current_price8 !== null && current_price8 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${34}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(35)) {
          if (current_price9 !== null && current_price9 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${35}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(36)) {
          if (current_price10 !== null && current_price10 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${36}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(37)) {
          if (current_price11 !== null && current_price11 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${37}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(38)) {
          if (current_price12 !== null && current_price12 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${38}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(39)) {
          if (current_price13 !== null && current_price13 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${39}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(40)) {
          if (current_price14 !== null && current_price14 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${40}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(41)) {
          if (current_price15 !== null && current_price15 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${41}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
      ...
      cor.data.map((info) => {
        if (String(info.prod_id).match(42)) {
          if (current_price16 !== null && current_price16 !== "") {
            ...
            axios
              .put(`http://localhost:8080/saveProduct/${42}`, value)
              .then((response) => {
                // handle success
                var resData = response.data;
                let data = JSON.stringify(resData);
  ...
  // Return for the DeptMen function
...
// exporting the DeptMen function
export default DeptMen;
