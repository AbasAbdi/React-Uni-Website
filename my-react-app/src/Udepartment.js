...
// Udepartment function
function Udepartment() {
  ...
  function handleUpdate1() {
    ...
    axios
      .put(`http://localhost:8080/updateCourse/${50}`, value)
      .then((response) => {
        // handle success
        var resData = response.data;
  ...
  function handleUpdate2() {
    ...
    axios
      .put(`http://localhost:8080/updateCourse/${60}`, value)
      .then((response) => {
        // handle success
        var resData = response.data;
        let data = JSON.stringify(resData);
  ...
  function handleUpdate3() {
    ...
    axios
      .put(`http://localhost:8080/updateCourse/${70}`, value)
      .then((response) => {
        // handle success
        var resData = response.data;
        let data = JSON.stringify(resData);
  ...
  function handleUpdate4() {
    ...
    axios
      .put(`http://localhost:8080/updateCourse/${80}`, value)
      .then((response) => {
        // handle success
        var resData = response.data;
        let data = JSON.stringify(resData);
  ...
  // Return for the Udepartment function
...
// exporting the Udepartment function
