...
function Postgrad() {
  ...
  if (vis === "cs") {
    return <CourseInfo id={90} />;
  } else if (vis === "ce") {
    return <CourseInfo id={100} />;
  } else if (vis === "bs") {
    return <CourseInfo id={110} />;
  } else if (vis === "bms") {
    return <CourseInfo id={120} />;
  }
  ...
  // Return for the Postgrad function
...
// exporting the Postgrad function
